...
import com.hsm.bulk.auth.TokenValidationException;
...
/** Duplicated verbatim from com.hsm.core.security.JwtAppIdAuthenticationFilter -- identical JWT + X-App-ID bridge into Spring Security, same audit event shapes/status codes. */
