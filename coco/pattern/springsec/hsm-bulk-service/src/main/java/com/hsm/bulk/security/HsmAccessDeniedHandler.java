...
import com.hsm.bulk.web.AuthenticatedCaller;
...
/** Duplicated from com.hsm.core.security.HsmAccessDeniedHandler -- same generic scope-denial audit payload/response shape. */
public class HsmAccessDeniedHandler implements AccessDeniedHandler {
    ...
    public HsmAccessDeniedHandler(HsmSecurityProperties securityProperties, HsmBulkProperties properties, AuditLogger auditLogger) {
